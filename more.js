...
let addMoreButton = () => {
    ...
    <button class="btn btn-primary author" title="Github" id="author" onclick="github()" type="submit"><i class="fas fa-user-plus"></i></button>
    <button class="btn btn-primary liveRun" title="Live Run" id="liveRun" onclick="LiveRun()" type="submit"><i class="fas fa-globe-europe"></i></button>
    ...
    <p id="credit"> D & D - Prashant Kumar</p>
